...
var position_arr = [
						...
						{id:'gro01', r:7, c:21, mask:[{r:7, c:19},{r:7, c:20},{r:7, c:21},{r:7, c:22},{r:7, c:23}], block:[{r:7, c:19},{r:7, c:20},{r:7, c:21},{r:7, c:22},{r:7, c:23}], area:[{r:8, c:19},{r:8, c:20},{r:8, c:21},{r:8, c:22},{r:8, c:23}], type:'item', item:8, cost:10, lock:{id:'grolock1', cost:1000, name:'DIÁRIO', x:0, y:0, regX:0, regY:50}, icon:{x:5, y:-48}},
						{id:'gro02', r:10, c:29, mask:[{r:8, c:29},{r:9, c:29},{r:10, c:29},{r:11, c:29},{r:12, c:29}], block:[{r:8, c:29},{r:9, c:29},{r:10, c:29},{r:11, c:29},{r:12, c:29}], area:[{r:8, c:28},{r:9, c:28},{r:10, c:28},{r:11, c:28},{r:12, c:28}], type:'item', item:8, cost:10, lock:{id:'grolock2', cost:1000, name:'DIÁRIO', x:0, y:0, regX:0, regY:130}, icon:{x:-5, y:-50}},
						{id:'gro03', r:7, c:26, mask:[{r:7, c:24},{r:7, c:25},{r:7, c:26},{r:7, c:27},{r:7, c:28}], block:[{r:7, c:24},{r:7, c:25},{r:7, c:26},{r:7, c:27},{r:7, c:28}], area:[{r:8, c:24},{r:8, c:25},{r:8, c:26},{r:8, c:27}], type:'item', item:8, cost:10, lock:{id:'grolock1', cost:1000, name:'DIÁRIO', x:0, y:0, regX:0, regY:130}, icon:{x:5, y:-48}},
						{id:'gro04', r:11, c:24, mask:[{r:11, c:22},{r:11, c:23},{r:11, c:24},{r:11, c:25},{r:11, c:26}], block:[{r:11, c:22},{r:11, c:23},{r:11, c:24},{r:11, c:25},{r:11, c:26}], area:[{r:12, c:22},{r:12, c:23},{r:12, c:24},{r:12, c:25},{r:12, c:26}], type:'item', item:8, cost:10, lock:{id:'grolock1', cost:1000, name:'DIÁRIO', x:0, y:0, regX:0, regY:50}, icon:{x:5, y:-48}},
						{id:'gro05', r:15, c:24, mask:[{r:15, c:22},{r:15, c:23},{r:15, c:24},{r:15, c:25},{r:15, c:26}], block:[{r:15, c:22},{r:15, c:23},{r:15, c:24},{r:15, c:25},{r:15, c:26}], area:[{r:16, c:22},{r:16, c:23},{r:16, c:24},{r:16, c:25},{r:16, c:26}], type:'item', item:8, cost:10, lock:{id:'grolock1', cost:1000, name:'DIÁRIO', x:0, y:0, regX:0, regY:0}, icon:{x:5, y:-48}},
						{id:'gro06', r:15, c:29, mask:[{r:13, c:29},{r:14, c:29},{r:15, c:29},{r:16, c:29},{r:17, c:29}], block:[{r:13, c:29},{r:14, c:29},{r:15, c:29},{r:16, c:29},{r:17, c:29}], area:[{r:13, c:28},{r:14, c:28},{r:15, c:28},{r:16, c:28},{r:17, c:28}], type:'item', item:8, cost:10, lock:{id:'grolock2', cost:1000, name:'DIÁRIO', x:0, y:0, regX:0, regY:60}, icon:{x:-5, y:-50}},

						{id:'promo01', r:19, c:19, mask:[{r:19, c:19},{r:18, c:19},{r:18, c:20},{r:19, c:20}], block:[{r:19, c:19},{r:18, c:19},{r:18, c:20},{r:19, c:20}], area:[{r:20, c:19},{r:20, c:20},{r:18, c:18},{r:19, c:18},{r:17, c:19},{r:17, c:20},{r:19, c:21},{r:18, c:21}], type:'item', item:8, cost:10, lock:{id:'promolock', cost:500, name:'DIÁRIO', x:-124, y:-74, regX:0, regY:0}, icon:{x:0, y:-45}},
						{id:'promo02', r:15, c:19, mask:[{r:15, c:19},{r:14, c:19},{r:14, c:20},{r:15, c:20}], block:[{r:15, c:19},{r:14, c:19},{r:14, c:20},{r:15, c:20}], area:[{r:16, c:19},{r:16, c:20},{r:15, c:18},{r:14, c:18},{r:13, c:19},{r:13, c:20},{r:14, c:21},{r:15, c:21}], type:'item', item:8, cost:10, lock:{id:'promolock', cost:500, name:'DIÁRIO', x:-56, y:-33, regX:0, regY:0}, icon:{x:0, y:-45}},
						{id:'promo03', r:11, c:19, mask:[{r:11, c:19},{r:10, c:19},{r:10, c:20},{r:11, c:20}], block:[{r:11, c:19},{r:10, c:19},{r:10, c:20},{r:11, c:20}], area:[{r:12, c:19},{r:12, c:20},{r:10, c:18},{r:11, c:18},{r:9, c:19},{r:9, c:20},{r:10, c:21},{r:11, c:21}], type:'item', item:8, cost:10, lock:{id:'promolock', cost:500, name:'DIÁRIO', x:0, y:0, regX:0, regY:0}, icon:{x:0, y:-45}},
